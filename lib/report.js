...
請寫一份 HTML 格式嘅週報（無 <html>/<body> tag，直接 fragment），200-450 字，包含：
...
${significantDiffs.length ? '列出有顯著改動 (>5%) 嘅 landing page，每個對手啱啱改咗咩可能策略。' : '今週冇 landing page 顯著改動，淨係寫一句 "上週對手 landing page 大致穩定"。'}
